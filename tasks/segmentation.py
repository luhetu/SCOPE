...
class SegmentationTask:
    ...
    def _build_mmseg_config(self):
        ...
        print(f"   seg_head_dim: {_as_int(getattr(args, 'seg_head_dim', None), self._get_default_seg_head_dim())}")
        print(f"   seg_aux_dim: {_as_int(getattr(args, 'seg_aux_dim', None), self._get_default_seg_head_dim())}")
