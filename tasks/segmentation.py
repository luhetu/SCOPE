...
class SegmentationTask:
    ...
    def _get_backbone_image_size(self):
        value = _arg_or_default(self.args, "backbone_size", _arg_or_default(self.args, "crop_size", self.args.size))
    ...
    def _get_data_config(self):
        ...
        crop_size = _as_pair(_arg_or_default(args, "crop_size", None), 512)
        img_scale = _as_pair(_arg_or_default(args, "img_scale", None), (2048, 512))
        test_img_scale = _as_pair(_arg_or_default(args, "test_img_scale", None), img_scale)
