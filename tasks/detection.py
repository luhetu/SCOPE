...
class DetectionTask:
    def __init__(self, args):
        ...
        if self.use_wandb:
            name = f"{self.run_name}_size{getattr(args, 'size', 'na')}_patch{getattr(args, 'patch', 'na')}_dim{getattr(args, 'dim', 'na')}_bs{args.bs}_lr{args.lr}"
