...
class DetectionTask:
    ...
    def _build_mmdet_config(self):
        ...
        cfg.optimizer = dict(
            ...
            weight_decay=_as_float_arg(args, "weight_decay", 0.05),
        ...
        cfg.log_config = dict(interval=_as_int_arg(args, "log_interval", 50), hooks=[dict(type="TextLoggerHook")])
        ...
        print(f"   lr: {args.lr}")
        print(f"   weight_decay: {_as_float_arg(args, 'weight_decay', 0.05)}")
