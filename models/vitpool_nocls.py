# -*- coding: utf-8 -*-
# ViT-HKPool (Full w/o CLS-aware): HKGate only, CLS has no special gating
import torch
...
class Attention(nn.Module):
    ...
    def forward(self, x, hk_gate_1d):
        ...
        # No CLS-aware gating: CLS gate is neutral (1.0)
...
# ---------------- ViT-HKPool 主Body (含 CLS,Read CLS) ----------------
class ViTPool_NoCLS(nn.Module):
    """
